<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ZCLBGL.aspx.cs" Inherits="Web_GZJL.admin.ZCLBGL" %>
                                                        ...
                                                        <tr>
                                                            <td>
                                                                <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" BorderWidth="0px"
                                                                    ...
                                                                    <Columns>
                                                                        <asp:TemplateField HeaderText="资产类别">
                                                                            <EditItemTemplate>
                                                                                <asp:TextBox ID="txt_mc" runat="server" Text='<%# Bind("zclbmc") %>' Width="170px"
                                                                                    MaxLength="50" Height="20px"></asp:TextBox>
                                                                            </EditItemTemplate>
                                                                            <ItemStyle HorizontalAlign="Center" Width="180px" />
                                                                            <HeaderStyle HorizontalAlign="Center" Width="180px" CssClass="dl" />
                                                                            <ItemTemplate>
                                                                                <asp:Label ID="lbl_zcname" runat="server" Text='<%# Bind("zclbmc") %>'></asp:Label>
                                                                            </ItemTemplate>
                                                                        </asp:TemplateField>
