                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td align="left">
                                                    ...
                                                    <asp:RadioButtonList ID="RadioButtonList1" runat="server" RepeatDirection="Horizontal">
                                                        <asp:ListItem Value="0" Selected="True">个人文档</asp:ListItem>
                                            ...
                                            <tr>
                                                ...
                                                <td align="left">
                                                    ...
                                                    &nbsp; 来文单位：<asp:TextBox ID="txt_lwdanwei" runat="server" Width="160px"></asp:TextBox><font
                                                        size="2" color="red">注：红头文件必须写文号和来文单位</font>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td align="center" style="height: 30px">
                                                ...
                                                <td align="left">
                                                    <asp:TextBox ID="txt_bianhao" runat="server" Width="180px"></asp:TextBox><font size="2"
                                                        color="red">注：请示报告需写编号，其他不用</font>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td align="center" style="height: 30px">
                                                                        ...
                                                                        <asp:TemplateField HeaderText="删除" ShowHeader="False">
                                                                            <ItemTemplate>
                                                                                <asp:LinkButton ID="btn_delete" runat="server" CausesValidation="False" CommandName="Delete"
                                                                                    Text="删除" OnClientClick="return confirm('确认删除此条培训内容吗')"></asp:LinkButton>
                                                                            </ItemTemplate>
                                                                            <ItemStyle HorizontalAlign="Center" Width="50px" />
                                                                ...
                                                                <table border="0" cellpadding="2" cellspacing="0" style="border-right: #C6E7B5 1px solid;
                                                                    ...
                                                                    <tr>
                                                                        ...
                                                                        <td width="53px" style="border-left: #c6e7b5 1px solid; border-collapse: collapse;
                                                                            ...
                                                                            <asp:LinkButton ID="but_add" runat="server" ToolTip="添加附件" OnClick="but_add_Click">添加</asp:LinkButton>
                                                                            <%--<asp:LinkButton ID="LinkButton3" runat="server" ToolTip="添加附件" 
                                                                                onclick="LinkButton3_Click" >添加1</asp:LinkButton>--%>
                                                                        </td>
                                                                    </tr>
                                                                </table>
                                                            </td>
