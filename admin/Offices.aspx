<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Offices.aspx.cs" Inherits="Web_GZJL.admin.Offices" %>
                                    ...
                                    <tr>
                                        ...
                                        <td align="left">
                                            ...
                                            <asp:UpdatePanel ID="UpdatePanel1" runat="server">
                                                <ContentTemplate>
                                                    <table cellspacing="0" cellpadding="0" border="0" width="36%">
                                                        <tr align="center">
                                                            <td>
                                                                <h2>
                                                                    处室管理</h2>
                                                        ...
                                                        <tr>
                                                            <td>
                                                                <asp:GridView ID="gv_filetype" runat="server" AutoGenerateColumns="False" BorderWidth="0px"
                                                                    ...
                                                                    OnRowDeleting="GridView2_RowDeleting" OnRowDataBound="gv_filetype_RowDataBound">
                                                                    <Columns>
                                                                        <asp:TemplateField HeaderText="处室名称">
                                                                            <EditItemTemplate>
                                                                                <asp:TextBox ID="txtType" runat="server" Text='<%# Bind("OFFICES") %>' Width="102px"
                                                                                    MaxLength="30" Height="20px"></asp:TextBox>
                                                                            </EditItemTemplate>
                                                                            <ItemStyle HorizontalAlign="Center" Width="180px" />
                                                                            <HeaderStyle HorizontalAlign="Center" Width="180px" CssClass="dl" />
                                                                            <ItemTemplate>
                                                                                <asp:Label ID="lbltypename" runat="server" Text='<%# Bind("OFFICES") %>'></asp:Label>
                                                                            </ItemTemplate>
                                                                        </asp:TemplateField>
                                                                        <asp:TemplateField HeaderText="所属区划">
                                                                            <EditItemTemplate>
                                                                                <%--<asp:TextBox ID="txtmanual" runat="server" Text='<%# Bind("DEPARTNAME") %>' Width="240px" MaxLength="120"
                                                                Height="20px"></asp:TextBox>--%>
                                                                                <asp:DropDownList ID="ddl_quhua2" runat="server" Width="100px">
                                                                                </asp:DropDownList>
                                                                            </EditItemTemplate>
                                                                ...
                                                                <table cellpadding="0" cellspacing="0" class="td2" style="border-collapse: collapse">
                                                                    ...
                                                                    <tr>
                                                                        ...
                                                                        <td width="305" align="left">
                                                                            <asp:DropDownList ID="ddl_quhua" runat="server" Width="160px">
                                                                            </asp:DropDownList>
                                                                        </td>
