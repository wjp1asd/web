<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SPHYCX.aspx.cs" Inherits="Web_GZJL.SPGL.SPHYCX" %>
                                                    ...
                                                    <td style="border-bottom: 1px solid #aaaaaa;">
                                                        ...
                                                        <table border="0" cellpadding="3" cellspacing="0">
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td align="left">
                                                                   <input id="txt_KsTime" runat="server" class="Wdate" type="text" onfocus="WdatePicker({readOnly:true,dateFmt:'yyyy-MM-dd'})"
                                                            style="width: 120px" />
                                                                </td>
                                                                <td align="left">
                                                                    至
                                                                ...
                                                                <td align="left">
                                                                  <input id="txt_JsTime" runat="server" class="Wdate" type="text" onfocus="WdatePicker({readOnly:true,dateFmt:'yyyy-MM-dd'})"
                                                            style="width: 120px" />
                                                                </td>
                                                                <td>
                                                                    <td align="left">
                                                        ...
                                                        <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" BorderWidth="0px"
                                                            ...
                                                            <Columns>
                                                                ...
                                                                <asp:TemplateField  HeaderText="主任签字">
                                                                    ...
                                                                    <HeaderStyle Width="80px" HorizontalAlign="Center" CssClass="dl" />
                                                                </asp:TemplateField>
                                            ...
                                            <table cellspacing="0" cellpadding="8" align="left"  border="1" style="border-collapse: collapse"
                                                ...
                                                <tr>
                                                    ...
                                                    <td align="left" colspan="3">
                                                        <asp:Label ID="lblname" runat="server" Text="Label" Width="400px"></asp:Label>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td align="center" style="height: 20px">
                                                ...
                                                <tr>
                                                    ...
                                                    <td align="left" colspan="2">
                                                        <asp:Label ID="lbl_zrpishi" runat="server" Text="" Width="390px"></asp:Label></td>
                                                </tr>
