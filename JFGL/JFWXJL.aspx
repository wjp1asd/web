<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="JFWXJL.aspx.cs" Inherits="Web_GZJL.JFGL.JFWXJL" %>
                    ...
                    <table width="100%" border="0" cellpadding="0" cellspacing="0">
                        ...
                        <tr>
                            ...
                            <asp:LinkButton ID="LinkButton1" runat="server"  PostBackUrl="~/JFGL/JFWHJL.aspx"><font color="red">设备维护</font></asp:LinkButton>
                                &nbsp;&nbsp;&nbsp;&nbsp;
                                <asp:LinkButton ID="LinkButton2" runat="server"  PostBackUrl="~/JFGL/JFWXJL.aspx"><font color="red">设备维修</font></asp:LinkButton></td></tr>
                        <tr>
                            <td style="width: 10px">
                            </td>
                            <td valign="top" align="left">
                                                    ...
                                                    <td style="border-bottom: 1px solid #aaaaaa;">
                                                        <table border="0" cellpadding="3" cellspacing="0">
                                                            <tr>
                                                                ...
                                                                <td>
                                                                    <input id="startTime" runat="server" type="text" onclick="WdatePicker()"
                                        ...
                                        <asp:Panel ID="Panel2" runat="server" Visible="False" Width="100%">
                                            ...
                                            <table cellspacing="0" cellpadding="8" align="left" border="1"   style="border-collapse: collapse" bordercolor="#6c9ec1">
                                                    ...
                                                    <td align="left">
                                                        ...
                                                        <asp:TextBox ID="txt_sbmcid" runat="server" BackColor="Transparent" BorderStyle="None"
                                                         ...
                                                         <img id="Img1" alt="请选择" onclick="Picker.show('../SELECT/Selzcsb.aspx',txt_sbmc,txt_sbmcid,'','','340','440');"
                                                                            src="../img/lookup.gif" />
                                                                            &nbsp;<a id="history" runat="server" href="#" onclick="history()" class="a2">历史记录</a>
                                                    </td>
                                                ...
                                                <tr>
                                                    ...
                                                    <td align="left">
                                                        <%--<asp:TextBox ID="txt_whptry" runat="server" Width="240px"></asp:TextBox>--%><asp:DropDownList ID="ddl_ptry" runat="server" Height="20px" Width="138px">
                                                        </asp:DropDownList>
                                                    </td>
                                                </tr>
                                                <tr>
                                                            ...
                                                            <tr>
                                                                <td>
                                                                    <asp:GridView ID="GridView2" runat="server" AutoGenerateColumns="False" BorderWidth="0px"
                                                                        ...
                                                                        CssClass="quanbu" OnRowDeleting="GridView2_RowDeleting">
                                                                        <Columns>
                                                ...
                                                <tr>
                                                    ...
                                                    <td align="left">
                                                        <asp:TextBox ID="txt_yijian" runat="server" Rows="4" TextMode="MultiLine" 
                                                ...
                                                <tr  >
                                                    <td align="center" colspan="2" height="26" >
                                                        ...
                                                        <asp:Button ID="btn_save" runat="server" CssClass="btn1" 
                                                            OnClick="btn_save_Click" Text="保 存" />
