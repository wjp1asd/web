<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ZCTYBFSH.aspx.cs" Inherits="Web_GZJL.ZCGL.ZCTYBFSH" %>
                                            ...
                                            <table cellspacing="0" cellpadding="8" align="left" border="1" style="border-collapse: collapse"
                                                ...
                                                <tr>
                                                    <td align="center" style="height: 20px">
                                                        设备备注</td>
                                                    <td align="left">
                                                         <asp:Label ID="lbl_beizhu" runat="server" Width="240px"></asp:Label></td>
                                                    <td align="left">
                                                        设备负责人</td>
                                                    <td align="left">
                                                         <asp:Label ID="lbl_sbfzr" runat="server" Text=""></asp:Label></td>
                                                </tr>
                                               <tr>
                                                    <td align="center" style="height: 20px">
                                                        供货商
                                                        ...
                                                        <table align="center" cellpadding="3" cellspacing="0" width="100%">
                                                            ...
                                                            <tr style="border-top:1px; border-top-color:#6c9ec1; border-bottom:0px; border-left:0px; border-right:0px; border-style:solid">
                                                                <td align="left" height="22">
                                                                    审核意见：
                                                                    <asp:TextBox ID="txt_yj" runat="server" MaxLength="1000" Width="500px" 
                                                ...
                                                <tr>
                                                    <td align="center" colspan="4" height="26">
                                                        ...
                                                        <asp:Button ID="btn_tj" runat="server" Text="审 核" CssClass="btn1" OnClick="btn_tj_Click">
                                                        </asp:Button>
