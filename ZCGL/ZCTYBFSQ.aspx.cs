...
{
    public partial class ZCTYBF : System.Web.UI.Page
    {
        public string t1 = "", t0 = "";
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!IsPostBack)
            {
               ...
               // DataBase.Exe_fill(DropDownList2, "select ID,zclbmc,bz from SYS_ZCLB", "ID", "zclbmc");//资产类别绑定
                ...
                ViewState["where"] = "  z.xzqhID='" + Session["XZQH"].ToString() + "' ";
        ...
        private void getData()
        {
            ...
            string sql = "select ID, sbshzt,case when sbshzt='0' then '未提交' when sbshzt='1' then '待审核' when sbshzt='2' then '驳回' when sbshzt='3' then '审核通过'  end as shzta,z.czmc as SBMC,z.czlbid as SBLBID,z.czlb as SBLB,z.xinghao as xh,z.zcid as xlh, z.jiage  as jine,z.grsj  as grsj,zczt,(case when z.zczt='0' then '使用中' when z.zczt='1' then '维修' when z.zczt='2' then '停用' when z.zczt='3' then '报废' end)as zcztxs,z.xxcs as xiangqing from TB_ZCSB z  where  " + ViewState["where"].ToString() + "  order by z.zczt   ";
            ...
            lbl_heji.Text = DataBase.Exe_Scalar("select count(*) FROM TB_ZCSB where xzqhid='" + Session["XZQH"].ToString() + "'");
        ...
        {
            string sql = "  z.xzqhID = '" + Session["XZQH"].ToString() + "'  ";
