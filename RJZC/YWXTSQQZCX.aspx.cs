...
{
    public partial class YWXTSQQZCX : System.Web.UI.Page
    {
        string nxid = "";
        public string t1 = "", t0 = "";
        ...
        {
            Response.Redirect("../RJZC/YWXTSQQZSH.aspx");
        }
        ...
        protected void btn_word_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                object objTemplate = Server.MapPath(@"..\\dot\\ywxtqxbgsqb.dot");//模板路径
                ...
                object filename = Server.MapPath("~\\doc\\") + "业务系统变更申请表" + shijian + ".doc";
                ...
                DownLoadFile("../doc/业务系统变更申请表" + shijian + ".doc");
