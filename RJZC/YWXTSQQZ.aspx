<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="YWXTSQQZ.aspx.cs" Inherits="Web_GZJL.RJZC.YWXTSQQZ" %>
                                                        ...
                                                        <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" BorderWidth="0px"
                                                            ...
                                                            <Columns>
                                                                <asp:TemplateField HeaderText="编号">
                                                                    ...
                                                                    <ItemTemplate>
                                                                        <a href='YWXTSQQZCX.aspx?idd=<%#Eval("ID") %>'>
                                                                ...
                                                                <asp:TemplateField HeaderText="功能要求">
                                                                    <ItemStyle HorizontalAlign="Left" Width="200px" />
                                                                    <ItemTemplate>
                                                                        <asp:Label ID="lbl_gnyq" runat="server" Text='<%#bind("gnyq") %>'>&#39;&gt;</asp:Label>
                                                                    </ItemTemplate>
                                            ...
                                            <table cellspacing="0" cellpadding="8" align="left" border="1" style="border-collapse: collapse"
                                                ...
                                                <tr>
                                                 <td align="center">
                                                    ...
                                                    <td align="left" >
                                                        <asp:DropDownList ID="ddl_quhua" runat="server" AutoPostBack="True" OnSelectedIndexChanged="ddl_quhua_SelectedIndexChanged" Width="140px">
                                                        </asp:DropDownList>
                                                    ...
                                                    <td align="left">
                                                        <asp:TextBox ID="txt_syr" runat="server" Width="220px"></asp:TextBox>
                                                    </td>
                                                ...
                                                <tr>
                                                    ...
                                                    <td align="left" colspan="3">
                                                        <asp:TextBox ID="txt_gnyq" runat="server" Width="594px" Rows="6" TextMode="MultiLine"></asp:TextBox>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td align="center" style="height: 20px">
                                                    ...
                                                    <td align="left" colspan="3">
                                                        <asp:TextBox ID="txt_sjyq" runat="server" Width="594px" Rows="5" TextMode="MultiLine"></asp:TextBox>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td align="center" style="height: 20px">
