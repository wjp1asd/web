<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="RJMC.aspx.cs" Inherits="Web_GZJL.RJZC.RJMC" %>
                                                        ...
                                                        <tr>
                                                            <td>
                                                                <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" BorderWidth="0px"
                                                                    ...
                                                                    <Columns>
                                                                        <asp:TemplateField HeaderText="预警项目 ">
                                                                            <EditItemTemplate>
                                                                                <asp:TextBox ID="txt_mc" runat="server" Text='<%# Bind("Type") %>' Width="170px"
                                                                        ...
                                                                        <asp:TemplateField HeaderText="预警天数">
                                                                            <EditItemTemplate>
                                                                                <asp:TextBox ID="txt_bz" runat="server" Text='<%# Bind("Times") %>' Width="290px" MaxLength="100"
                                                                                    Height="20px"></asp:TextBox>
                                                                            </EditItemTemplate>
                                                                            <ItemStyle HorizontalAlign="Left" Width="300px" />
                                                                            <HeaderStyle HorizontalAlign="Center" Width="300px" CssClass="dl" />
                                                                            <ItemTemplate>
                                                                                <asp:Label ID="Label2" runat="server" Text='<%# Bind("Times") %>'></asp:Label>
                                                                            </ItemTemplate>
                                                                        </asp:TemplateField>
