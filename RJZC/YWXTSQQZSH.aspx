<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="YWXTSQQZSH.aspx.cs" Inherits="Web_GZJL.RJZC.YWXTSQQZSH" %>
                                                                ...
                                                                <asp:TemplateField HeaderText="审核" ShowHeader="False">
                                                                    <ItemTemplate>
                                                                        <asp:LinkButton ID="LinkButton1" runat="server" CausesValidation="False" CommandName="Select"
                                                                            CssClass="a2" Text="<div>审核</div>"></asp:LinkButton>
                                                                    </ItemTemplate>
                                        ...
                                        <asp:Panel ID="Panel2" runat="server" Visible="False" Width="100%">
                                            ...
                                            <table cellspacing="0" cellpadding="8" align="left" border="1" style="border-collapse: collapse"
                                                ...
                                                <tr>
                                                    ...
                                                    <td align="left" colspan="3">
                                                        <asp:Label ID="lbl_gnyq" runat="server" Text="" Width="594px"></asp:Label>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td align="center" style="height: 20px">
                                                ...
                                                <tr>
                                                    <td align="center" colspan="4" height="26">
                                                        ...
                                                        <asp:Button ID="btn_save" runat="server" Text="批示完毕" CssClass="btn2" OnClick="btn_save_Click">
                                                        </asp:Button>&nbsp; &nbsp;&nbsp; &nbsp;&nbsp; &nbsp;<asp:Button ID="btn_bohui" runat="server"
                                                            Text="返 回" CssClass="btn1" OnClick="btn_bohui_Click"></asp:Button>
                                                        <br />
                                                    </td>
                                                </tr>
                                            </table>
