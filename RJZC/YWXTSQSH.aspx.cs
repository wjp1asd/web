...
{
    public partial class YWXTSQSH : System.Web.UI.Page
    {
        public string t1 = "", t0 = "";
        ...
        protected void btn_save_Click(object sender, EventArgs e)
        {
            ...
            //0待审核，1通过，2驳回
            string str = "UPDATE TB_SYSQ SET xxzx = '" + txt_xxzx.Text.Trim() + "',bz = '" + txt_bz.Text.Trim() + "',shzt = '1'  WHERE ID = '" + this.lbl_id.Text + "'";
