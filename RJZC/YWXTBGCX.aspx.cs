...
{
    public partial class YWXTBGCX : System.Web.UI.Page
    {
        string nxid = "";
        public string t1 = "", t0 = "";
        ...
        protected void btn_word_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                object objTemplate = Server.MapPath(@"..\\dot\\ywxtsjxgsqb.dot");//模板路径
                ...
                //    DataRow dr = dte.Rows[0];
                    ...
                    docFile.Bookmarks.get_Item(ref gnyq).Range.Text = lbl_sjyq.Text;//功能要求
                    ...
                    object filename = Server.MapPath("~\\doc\\") + "业务系统数据修改申请表" + shijian + ".doc";
                    ...
                    DownLoadFile("../doc/业务系统数据修改申请表" + shijian + ".doc");
