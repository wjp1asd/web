<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="XXJSB.aspx.cs" Inherits="Web_GZJL.WLGL.XXJSB" %>
                                                    ...
                                                    <td align="left" valign="top">
                                                        <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" BorderWidth="0px"
                                                            ...
                                                            <Columns>
                                                                ...
                                                                <asp:BoundField DataField="" HeaderText="购买时间">
                                            ...
                                            <table cellspacing="0" cellpadding="8" align="left" class="td1" style="border-collapse: collapse">
                                                 <tr>
                                                    <td align="center" style="height: 20px">
                                                        设备名称</td>
                                                    <td align="left">
                                                        <asp:TextBox ID="txtname" runat="server" Width="240px"></asp:TextBox> </td>
                                                    <td align="left">
                                                      
                                                        管理人</td>
                                                     <td align="left">
                                                          <asp:TextBox ID="txtadmin" runat="server" Width="240px"></asp:TextBox> </td>
                                                </tr>
                                                <tr>
                                                    <td align="center" style="height: 20px">
                                                        设备型号</td>
                                                    <td align="left">
                                                       <asp:TextBox ID="txtversion" runat="server" Width="240px"></asp:TextBox> </td>
                                                    <td align="left">
                                                        设备序列号
                                                       </td>
                                                     <td align="left">
                                                         <asp:TextBox ID="txteqnumber" runat="server" Width="240px"></asp:TextBox></td>
                                                </tr>
                                                <tr>
                                                    <td align="center" style="height: 20px">
                                                        用途</td>
                                                    ...
                                                    <td align="left">
                                                     ...
                                                     <td align="left">
                                                          <asp:TextBox ID="txtnumber" runat="server" Width="240px"></asp:TextBox></td>
                                                </tr>
                                                <tr>
                                                    <td align="center" style="height: 20px">
                                                        购买时间 </td>
                                                    <td align="left">
                                                        <input id="txtbuytime" runat="server" class="Wdate" type="text" onclick="WdatePicker()"
                                                            onfocus="WdatePicker({isShowClear:false,readOnly:true})" style="width: 240px" /></td>
                                                    <td align="left">
                                                        保修截止日期
                                                        </td>
                                                     <td align="left">
                                                          <input id="txtovertime" runat="server" class="Wdate" type="text" onclick="WdatePicker()"
                                                            onfocus="WdatePicker({isShowClear:false,readOnly:true})" style="width: 240px" /> </td>
                                                </tr>
                                                <tr>
                                                    <td align="center" style="height: 20px">
                                                    ...
                                                    <td align="left">
                                                        供应商联系方式</td>
                                                     <td align="left">
                                                         <asp:TextBox ID="txtsuppliertel" runat="server" Width="240px"></asp:TextBox> </td>
                                                </tr>
                                                <tr>
                                                    <td align="center" style="height: 20px">
                                                        CPU数量和频率 </td>
                                                    <td align="left">
                                                         <asp:TextBox ID="txtcpu" runat="server" Width="240px"></asp:TextBox></td>
                                                    <td align="left">
                                                        内存容量
                                                        </td>
                                                     <td align="left">
                                                         <asp:TextBox ID="txtmemory" runat="server" Width="240px"></asp:TextBox></td>
                                                </tr>
                                                <tr>
                                                    <td align="center" style="height: 20px">
                                                        硬盘数量和大小</td>
                                                    <td align="left">
                                                         <asp:TextBox ID="txtharddisk" runat="server" Width="240px"></asp:TextBox></td>
                                                    <td align="left">
                                                        磁盘阵列容量
                                                        </td>
                                                     <td align="left">
                                                         <asp:TextBox ID="txtharddiskarray" runat="server" Width="240px"></asp:TextBox></td>
                                                </tr>
